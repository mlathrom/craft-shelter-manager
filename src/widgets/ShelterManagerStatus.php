...
namespace mlathromsheltermanager\sheltermanager\widgets;

use mlathromsheltermanager\sheltermanager\ShelterManager;
use mlathromsheltermanager\sheltermanager\assetbundles\sheltermanagerstatuswidget\ShelterManagerStatusWidgetAsset;

use Craft;
use craft\base\Widget;

/**
 * Shelter Manager Widget
 *
 ...
 * @since     1.0.0
 */
class ShelterManagerStatus extends Widget
{
    ...
    {
        return Craft::t('shelter-manager', 'ShelterManagerStatus');
    }
    ...
    {
        return Craft::getAlias("@mlathromsheltermanager/sheltermanager/assetbundles/sheltermanagerstatuswidget/dist/img/ShelterManagerStatus-icon.svg");
    }
    ...
    public function getSettingsHtml()
    {
        return Craft::$app->getView()->renderTemplate(
            'shelter-manager/_components/widgets/ShelterManagerStatus_settings',
            [
                'widget' => $this
            ]
        );
    ...
    {
        Craft::$app->getView()->registerAssetBundle(ShelterManagerStatusWidgetAsset::class);

        return Craft::$app->getView()->renderTemplate(
            'shelter-manager/_components/widgets/ShelterManagerStatus_body',
            [
